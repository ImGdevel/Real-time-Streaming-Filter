...
class RealStreamView(QWidget):
    ...
    def setup_toolbar(self):
        ...
        self.toolbar.setStyleSheet(f'background-color: {Colors.baseColor01}; border-radius: 10px;')  # 배경색 및 테두리 설정
